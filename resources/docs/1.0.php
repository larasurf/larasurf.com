...
return [
    [
        ...
        'content' => [
            ...
            [
                'type' => 'paragraph',
                'html' => 'Your journey of rapidly implementing, deploying, and iterating upon your next Laravel project begins here.',
            ],
            [
                'type' => 'callout',
        ...
        'content' => [
            ...
            [
                ...
                'items' => [
                    ...
                    'The <span class="inline-code">docker-compose.yml</span> file is updated if Laravel Dusk was selected',
    ...
    [
        ...
        'content' => [
            ...
            [
                'type' => 'callout',
                'html' => 'The below example is for a hypothetical project called <span class="inline-code">my-project</span> within an organization named <span class="inline-code">my-org</span>. Replace this project name and organization name with the name of your own project and organization/account.',
            ],
            [
                'type' => 'paragraph',
...
[13669] Failed to execute script docker-compose',
    ...
    [
        ...
        'content' => [
            ...
            [
                'type' => 'checkbox',
                'html' => 'Create a <a href="https://github.com/new" target="_blank">new GitHub repository</a> for your project, with a name that should exactly match the project name (slug) of your LaraSurf project and be in lowercase.<br/>If you are unsure of this value, you can run the following command to get the project name:<br/><span class="inline-code">surf config get project-name</span>.',
            ],
            [
                'type' => 'checkbox',
