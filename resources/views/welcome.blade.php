...
@section('content')
    <div class="relative">
        <div class="flex justify-center mt-16 xl:mt-48">
        ...
        <div class="flex justify-center mt-12 xl:mt-18">
            <div class="flex flex-wrap w-full xl:w-3/5 items-center justify-center">
