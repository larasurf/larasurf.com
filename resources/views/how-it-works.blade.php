...
@section('content')
    <div class="hidden lg:block static-menu-width">
        <div class="fixed static-side-menu flex">
            ...
            <div class="flex-grow">
                <a href="#title" class="block static-menu-width font-medium text-lg pl-6 py-2 hover:text-gray-400">How it works</a>
                <a href="#project-generation" class="block static-menu-width font-medium pl-9 py-2 hover:text-gray-400">Project Generation</a>
                <a href="#assumed-needs" class="block static-menu-width font-medium pl-9 py-2 hover:text-gray-400">Assumed Needs</a>
                <a href="#cloud-infrastructure" class="block static-menu-width font-medium pl-9 py-2 hover:text-gray-400">Cloud Infrastructure</a>
                <a href="#circleci-pipeline" class="block static-menu-width font-medium pl-9 py-2 hover:text-gray-400">CircleCI Pipeline</a>
            </div>
        </div>
    </div>
    <div class="relative content w-full lg:w-auto pt-2">
        <x-heading-1 id="title" margin-top="2">How it works</x-heading-1>
